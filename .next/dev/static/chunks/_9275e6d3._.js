...
function ParentDashboard() {
    ...
    const fetchChildStats = async (childId)=>{
        try {
            const { data: expenses } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('expenses').select('amount, type').eq('user_id', childId);
            const { data: tasks } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('tasks').select('status').eq('user_id', childId);
            const { count: meals } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('meals').select('*', {
                count: 'exact',
                head: true
...
_s(ParentDashboard, "Ck4kWtca5XuJsVv1O/uTCve5BPg=", false, function() {
    return [
...
//# sourceMappingURL=_9275e6d3._.js.map